...
# from MPIE_TEST_Side import MPIE_Test
...
if __name__=="__main__":
    ...
    # parser.add_argument('-data-place', type=str, default='../test/{}'.format(ImageName), help='prepared data path to run program')
    ...
    parser.add_argument('-csv-file', type=str, default='../DataList/MPIE_FOCropped_GalleryProbe.csv', help='csv file to load image for training')
    ...
    #                     default='../../04_FaceEvaluation/Experiment_IJBA_Mean_v02/Feature/{}'.format(ImageName), help='prepared data path to run program')
    ...
    _ = Validate_MPIE(Model, '{}'.format(args.model_select), device, args)
    exit()
